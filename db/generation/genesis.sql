...
(
    ...
    CONSTRAINT PK_LINE_STOP PRIMARY KEY (LINE_ID,ORDER_STOP),
...
(
    ...
    SENDER_TYPE VARCHAR2 NOT NULL,

    CONSTRAINT PK_MESSAGE_SENDER PRIMARY KEY (ID_TYPE)
);

CREATE TABLE DISCUSSION
(
    DISCUSSION_ID INT NOT NULL,
    DISCUSSION_SUBJECT VARCHAR2(255) NOT NULL,
    USER_ID INT DEFAULT NULL,
    USER_MAIL VARCHAR2(255) DEFAULT NULL,
    USER_PHONE VARCHAR2(10) DEFAULT NULL,
    USER_LASTNAME VARCHAR2(255) DEFAULT NULL,
    USER_FIRSTNAME VARCHAR2(255) DEFAULT NULL,
...
(
    ...
    CONSTRAINT PK_MESSAGE PRIMARY KEY (DISCUSSION_ID,MESSAGE_TIME,SENDER),
    CONSTRAINT FK_DISCUSSION_ID FOREIGN KEY (DISCUSSION_ID) REFERENCES DISCUSSION(DISCUSSION_ID),
    CONSTRAINT FK_SENDER FOREIGN KEY (SENDER) REFERENCES MESSAGE_SENDER(ID_TYPE)
);

CREATE TABLE ALERT_TYPE (
    ALERT_TYPE_ID INT NOT NULL,
    ALERT_TYPE_TIME INT NOT NULL,
    ALERT_TYPE_LABEL VARCHAR2(255) NOT NULL,

    CONSTRAINT PK_ALERT_TYPE PRIMARY KEY (ALERT_TYPE_ID)
);
CREATE TABLE ALERT (
    TRAVEL_ID INT NOT NULL,
    ALERT_TYPE_ID INT NOT NULL,
    ALERT_DATE TIMESTAMP,
    ALERT_MESSAGE VARCHAR2(255) NOT NULL,
    ALERT_LOCATION VARCHAR2(255) NOT NULL,
    ALERT_STATUS VARCHAR2(255) NOT NULL,


    CONSTRAINT PK_ALERT PRIMARY KEY (TRAVEL_ID, ALERT_DATE, ALERT_TYPE_ID),
    CONSTRAINT FK_ALERT_TYPE FOREIGN KEY (ALERT_TYPE_ID) REFERENCES ALERT_TYPE (ALERT_TYPE_ID),
    CONSTRAINT FK_ALERT_TRAVEL FOREIGN KEY (TRAVEL_ID) REFERENCES TRAVEL (TRAVEL_ID)
);

INSERT INTO ALERT_TYPE VALUES (1, 30, 'Bomb');
INSERT INTO ALERT_TYPE VALUES (2, 30, 'Gun');
INSERT INTO ALERT_TYPE VALUES (3, 30, 'Rescue');
INSERT INTO ALERT_TYPE VALUES (4, 30, 'Medical');
INSERT INTO ALERT_TYPE VALUES (5, 10, 'Rail Crossing');
INSERT INTO ALERT_TYPE VALUES (6, 10, 'Railway');
INSERT INTO ALERT_TYPE VALUES (7, 10, 'Sign');
INSERT INTO ALERT_TYPE VALUES (8, 10, 'Electric');
INSERT INTO ALERT_TYPE VALUES (9, 10, 'Maintenance');
INSERT INTO ALERT_TYPE VALUES (10, 15, 'Temperature');
INSERT INTO ALERT_TYPE VALUES (11, 30, 'Fire');
INSERT INTO ALERT_TYPE VALUES (12, 5, 'Other');