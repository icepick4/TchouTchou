...
class TrainDAO extends DAO
{
    ...
    {
        $sql = 'SELECT t.PRICE, t.START_TIME, t.TRAVEL_ID, l.LINE_ID, t.START_STATION_ID FROM LINE l, TRAVEL t WHERE l.START_STATION_ID = :station_from AND l.END_STATION_ID = :station_to AND l.LINE_ID IN (SELECT LINE_ID FROM TRAVEL WHERE START_TIME > :date_travel AND :date_travel < START_TIME + 1)';
