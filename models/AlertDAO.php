...
class AlertDAO extends DAO{
    ...
    public function getAllCurrentAlertsType(){
        $sql = 'SELECT DISTINCT ALERT_TYPE_LABEl, TRAVEL_ID, A.ALERT_TYPE_ID, TO_CHAR(ALERT_DATE,\'DD/MM/YYYY HH24:MI\') AS "DATETIME_TRAVEL", ALERT_MESSAGE, ALERT_LOCATION FROM ALERT A INNER JOIN ALERT_TYPE A_T ON A.ALERT_TYPE_ID=A_T.ALERT_TYPE_ID WHERE ALERT_STATUS=1';
        return $this->queryAll($sql);
    }
