...
CREATE TABLE DISCUSSION_SUPPORT
(
...
(
    ...
    CONSTRAINT PK_MESSAGE_SUPPORT PRIMARY KEY (DISCUSSION_ID,MESSAGE_TIME,SENDER),
    CONSTRAINT FK_DISCUSSION_ID FOREIGN KEY (DISCUSSION_ID) REFERENCES DISCUSSION_SUPPORT(DISCUSSION_ID),
